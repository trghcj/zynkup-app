        ...
        child: AnimatedContainer(
          ...
          child: Row(
            ...
            children: [
              ...
              // Label — only when expanded, no Expanded widget (causes overflow)
              if (widget.expanded) ...[
      ...
      child: Column(
        ...
        children: [
          ...
          _ActionBtn(
            ...
            sublabel: 'Publish a new campus event',
            ...
            child: Row(children: [
              Stack(clipBehavior: Clip.none, children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.white
                        .withOpacity(widget.gradient != null ? 0.2 : 0.0),
                    borderRadius: BorderRadius.circular(11),
                  ),
